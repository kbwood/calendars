$(function() {
	...
	test('Iranian calendar', function() {
		expect(57);
		var ic = $.calendars.instance('Iranian');
		equal(ic.monthsInYear(1403), 12, 'Iranian - months in year 1403');
		equal(ic.monthsInYear(1404), 12, 'Iranian - months in year 1404');
		equal(ic.monthsInYear(1405), 12, 'Iranian - months in year 1405');
		equal(ic.monthsInYear(1406), 12, 'Iranian - months in year 1406');
		equal(ic.monthsInYear(1407), 12, 'Iranian - months in year 1407');
		equal(ic.monthsInYear(1408), 12, 'Iranian - months in year 1408');
		equal(ic.leapYear(1403), true, 'Iranian - leap year 1403');
		equal(ic.leapYear(1404), false, 'Iranian - leap year 1404');
		equal(ic.leapYear(1405), false, 'Iranian - leap year 1405');
		equal(ic.leapYear(1406), false, 'Iranian - leap year 1406');
		equal(ic.leapYear(1407), false, 'Iranian - leap year 1407');
		equal(ic.leapYear(1408), true, 'Iranian - leap year 1408');
		equal(ic.daysInYear(1403), 366, 'Iranian - days in year 1403');
		equal(ic.daysInYear(1404), 365, 'Iranian - days in year 1404');
		equal(ic.daysInYear(1405), 365, 'Iranian - days in year 1405');
		equal(ic.daysInYear(1406), 365, 'Iranian - days in year 1406');
		equal(ic.daysInYear(1407), 365, 'Iranian - days in year 1407');
		equal(ic.daysInYear(1408), 366, 'Iranian - days in year 1408');
		equal(ic.daysInMonth(1403, 1), 31, 'Iranian - days in month Far 1403');
		equal(ic.daysInMonth(1403, 2), 31, 'Iranian - days in month Ord 1403');
		equal(ic.daysInMonth(1403, 3), 31, 'Iranian - days in month Kho 1403');
		equal(ic.daysInMonth(1403, 4), 31, 'Iranian - days in month Tir 1403');
		equal(ic.daysInMonth(1403, 5), 31, 'Iranian - days in month Mor 1403');
		equal(ic.daysInMonth(1403, 6), 31, 'Iranian - days in month Sha 1403');
		equal(ic.daysInMonth(1403, 7), 30, 'Iranian - days in month Meh 1403');
		equal(ic.daysInMonth(1403, 8), 30, 'Iranian - days in month Aba 1403');
		equal(ic.daysInMonth(1403, 9), 30, 'Iranian - days in month Aza 1403');
		equal(ic.daysInMonth(1403, 10), 30, 'Iranian - days in month Dey 1403');
		equal(ic.daysInMonth(1403, 11), 30, 'Iranian - days in month Bah 1403');
		equal(ic.daysInMonth(1403, 12), 30, 'Iranian - days in month Esf 1403');
		equal(ic.daysInMonth(1404, 1), 31, 'Iranian - days in month Far 1404');
		equal(ic.daysInMonth(1404, 2), 31, 'Iranian - days in month Ord 1404');
		equal(ic.daysInMonth(1404, 3), 31, 'Iranian - days in month Kho 1404');
		equal(ic.daysInMonth(1404, 4), 31, 'Iranian - days in month Tir 1404');
		equal(ic.daysInMonth(1404, 5), 31, 'Iranian - days in month Mor 1404');
		equal(ic.daysInMonth(1404, 6), 31, 'Iranian - days in month Sha 1404');
		equal(ic.daysInMonth(1404, 7), 30, 'Iranian - days in month Meh 1404');
		equal(ic.daysInMonth(1404, 8), 30, 'Iranian - days in month Aba 1404');
		equal(ic.daysInMonth(1404, 9), 30, 'Iranian - days in month Aza 1404');
		equal(ic.daysInMonth(1404, 10), 30, 'Iranian - days in month Dey 1404');
		equal(ic.daysInMonth(1404, 11), 30, 'Iranian - days in month Bah 1404');
		equal(ic.daysInMonth(1404, 12), 29, 'Iranian - days in month Esf 1404');
		equal(ic.daysInWeek(), 7, 'Iranian - days in week');
		equal(ic.epoch(2000), 'SH', 'Iranian - epoch 2000');
		equal(ic.epoch(-20), 'BSH', 'Iranian - epoch -20');
		var date = ic.newDate(1403, 12, 30);
		equal(ic.weekOfYear(date), 52, 'Iranian - week ' + date);
		date = ic.newDate(1388, 1, 1);
		equal(ic.weekOfYear(date), 1, 'Iranian - week ' + date);
		date = ic.newDate(1388, 1, 7);
		equal(ic.weekOfYear(date), 1, 'Iranian - week ' + date);
		date = ic.newDate(1388, 1, 8);
		equal(ic.weekOfYear(date), 2, 'Iranian - week ' + date);
		date = ic.newDate(1388, 12, 28);
		equal(ic.weekOfYear(date), 52, 'Iranian - week ' + date);
		date = ic.newDate(1388, 12, 29);
		equal(ic.weekOfYear(date), 53, 'Iranian - week ' + date);
		date = ic.newDate(1389, 1, 6);
		equal(ic.weekOfYear(date), 53, 'Iranian - week ' + date);
		date = ic.newDate(1389, 1, 7);
		equal(ic.weekOfYear(date), 1, 'Iranian - week ' + date);
		date = ic.newDate(1391, 12, 29);
		equal(ic.weekOfYear(date), 52, 'Iranian - week ' + date);
		date = ic.newDate(1392, 1, 2);
		equal(ic.weekOfYear(date), 52, 'Iranian - week ' + date);
		date = ic.newDate(1392, 1, 3);
		equal(ic.weekOfYear(date), 1, 'Iranian - week ' + date);
		date = ic.newDate(1392, 1, 9);
		equal(ic.weekOfYear(date), 1, 'Iranian - week ' + date);
	});

	test('Iranian days', function() {
		expect(29);
		var ic = $.calendars.instance('Iranian');
		var d = ic.newDate(1403, 10, 14);
		equal(d.year(), 1403, 'Iranian - year');
		equal(d.month(), 10, 'Iranian - month');
		equal(d.day(), 14, 'Iranian - day');
		equal(d.leapYear(), true, 'Iranian - leap year');
		equal(d.dayOfWeek(), 5, 'Iranian - day of week');
		equal(d.weekDay(), false, 'Iranian - week day');
		equal(d.dayOfYear(), 290, 'Iranian - day of year');
		equal(d.toJD(), 2460678.5, 'Iranian - Julian date');
		equalDate(d.toJSDate(), new Date(2025, 1 - 1, 3), 'Iranian - JS Date');
		d.date(1404, 10, 11);
		equal(d.year(), 1404, 'Iranian - year');
		equal(d.month(), 10, 'Iranian - month');
		equal(d.day(), 11, 'Iranian - day');
		equal(d.leapYear(), false, 'Iranian - leap year');
		equal(d.dayOfWeek(), 4, 'Iranian - day of week');
		equal(d.weekDay(), true, 'Iranian - week day');
		equal(d.dayOfYear(), 287, 'Iranian - day of year');
		equal(d.toJD(), 2461041.5, 'Iranian - Julian date');
		equalDate(d.toJSDate(), new Date(2026, 1 - 1, 1), 'Iranian - JS Date');
		d = ic.today();
		var today = new Date();
		equalDate(d.toJSDate(), today, 'Iranian - today');
		equal(ic.isValid(1404, 12, 29), true, 'Iranian - valid 29/12/1404');
		equal(ic.isValid(1404, 12, 30), false, 'Iranian - valid 30/12/1404');
		equal(ic.isValid(1403, 12, 29), true, 'Iranian - valid 29/12/1403');
		equal(ic.isValid(1403, 12, 30), true, 'Iranian - valid 30/12/1403');
		equal(ic.isValid(-1, 12, 29), true, 'Iranian - valid 29/12/-0001');
		equal(ic.isValid(0, 12, 29), false, 'Iranian - valid 29/12/0000');
		equal(ic.isValid(1403, -1, 28), false, 'Iranian - valid 28/-1/1403');
		equal(ic.isValid(1403, 14, 28), false, 'Iranian - valid 28/14/1403');
		equal(ic.isValid(1403, 2, -1), false, 'Iranian - valid -1/02/1403');
		equal(ic.isValid(1403, 2, 88), false, 'Iranian - valid 88/02/1403');
	});

	test('Iranian vs Julian Date', function() {
		expect(10);
		var ic = $.calendars.instance('Iranian');
		var tests = [[-1, 12, 29, 1948318.5],
			[1, 1, 1, 1948320.5], [500, 1, 1, 2130575.5],
			[1000, 1, 1, 2313197.5], [1403, 1, 1, 2460389.5]];
		// http://www.fourmilab.ch/documents/calendar/
		for (var i = 0; i < tests.length; i++) {
			date = ic.newDate(tests[i][0], tests[i][1], tests[i][2]);
			equal(date.toJD(), tests[i][3], 'Iranian - to Julian ' + date);
			equalCDate(ic.fromJD(tests[i][3]), date, 'Iranian - from Julian ' + date);
		}
	});

	test('Iranian add', function() {
		expect(12);
		var ic = $.calendars.instance('Iranian');
		var d = ic.newDate(1388, 1, 2);
		d.add(1, 'y');
		equalCDate(d, ic.newDate(1389, 1, 2), 'Iranian - add 1 y');
		d.add(-2, 'y');
		equalCDate(d, ic.newDate(1387, 1, 2), 'Iranian - add -2 y');
		d.add(1, 'm');
		equalCDate(d, ic.newDate(1387, 2, 2), 'Iranian - add 1 m');
		d.add(-2, 'm');
		equalCDate(d, ic.newDate(1386, 12, 2), 'Iranian - add -2 m');
		d.add(1, 'w');
		equalCDate(d, ic.newDate(1386, 12, 9), 'Iranian - add 1 w');
		d.add(-2, 'w');
		equalCDate(d, ic.newDate(1386, 11, 25), 'Iranian - add -2 w');
		d.add(1, 'd');
		equalCDate(d, ic.newDate(1386, 11, 26), 'Iranian - add 1 d');
		d.add(-2, 'd');
		equalCDate(d, ic.newDate(1386, 11, 24), 'Iranian - add -2 d');
		d.add(1, 'd').add(1, 'w').add(1, 'm').add(1, 'y');
		equalCDate(d, ic.newDate(1388, 1, 2), 'Iranian - add 1 d, 1 w, 1 m, 1 y');
		d.date(1387, 12, 20).add(2, 'w');
		equalCDate(d, ic.newDate(1388, 1, 4), 'Iranian - add 2 w over leap day');
		d.date(1387, 11, 30).add(1, 'm');
		equalCDate(d, ic.newDate(1387, 12, 30), 'Iranian - add 1 m for leap day');
		d.date(1387, 12, 30).add(1, 'y');
		equalCDate(d, ic.newDate(1388, 12, 29), 'Iranian - add 1 y to leap day');
	});

	test('Iranian compare', function() {
		expect(7);
		var ic = $.calendars.instance('Iranian');
		var d1 = ic.newDate(1388, 5, 8);
		var d2 = ic.newDate(1388, 5, 14);
		equal(d1.compareTo(d2), -1, 'Iranian compare - 08/05/1388 - 14/05/1388');
		equal(d2.compareTo(d1), +1, 'Iranian compare - 14/05/1388 - 08/05/1388');
		equal(d1.compareTo(d1), 0, 'Iranian compare - 08/05/1388 - 08/05/1388');
		d2 = ic.newDate(1388, 7, 8);
		equal(d1.compareTo(d2), -1, 'Iranian compare - 08/05/1388 - 08/07/1388');
		equal(d2.compareTo(d1), +1, 'Iranian compare - 08/07/1388 - 08/05/1388');
		d2 = ic.newDate(1390, 5, 8);
		equal(d1.compareTo(d2), -1, 'Iranian compare - 08/05/1388 - 08/05/1390');
		equal(d2.compareTo(d1), +1, 'Iranian compare - 08/05/1390 - 08/05/1388');
	});

	test('Iranian format', function() {
		expect(14);
		var ic = $.calendars.instance('Iranian');
		var d = ic.newDate(1388, 2, 3);
		equal(ic.formatDate(d), '1388/02/03', 'Iranian format - default');
		equal(ic.formatDate('dd/mm/yyyy', d), '03/02/1388', 'Iranian format - dd/mm/yyyy');
		equal(ic.formatDate('d/m/yy', d), '3/2/88', 'Iranian format - d/m/yy');
		equal(ic.formatDate('yyyy-mm-dd', d), '1388-02-03', 'Iranian format - yyyy-mm-dd');
		equal(ic.formatDate('yy-o', d), '88-34', 'Iranian format - yy-o');
		equal(ic.formatDate('yyyy-oo', d), '1388-034', 'Iranian format - yyyy-oo');
		equal(ic.formatDate('D, M d, yyyy', d), 'Panj, Ord 3, 1388', 'Iranian format - D, M d, yyyy');
		equal(ic.formatDate('DD, MM d, yyyy', d), 'Panjshanbeh, Ordibehesht 3, 1388',
			'Iranian format - DD, MM d, yyyy');
		equal(ic.formatDate('\'day\' d \'of\' MM \'in the year\' YYYY', d),
			'day 3 of Ordibehesht in the year 1388',
			'Iranian format - \'day\' d \'of\' MM \'in the year\' YYYY');
		equal(ic.formatDate('@', d), '1240444800', 'Iranian format - @');
		equal(ic.formatDate('!', d), '633760416000000000', 'Iranian format - !');
		equal(ic.formatDate('J', d), '2454944.5', 'Iranian format - J');
		equal(d.formatDate(), '1388/02/03', 'Iranian date format - default');
		equal(d.formatDate('dd/mm/yyyy'), '03/02/1388', 'Iranian date format - dd/mm/yyyy');
	});

	test('Iranian parse', function() {
		expect(16);
		var ic = $.calendars.instance('Iranian');
		var d = ic.newDate(1388, 2, 3);
		equal(ic.parseDate('', ''), null, 'Iranian parse - empty');
		equalCDate(ic.parseDate('', '1388/02/03'), d, 'Iranian parse - default');
		equalCDate(ic.parseDate('dd/mm/yyyy', '3/2/1388'), d, 'Iranian parse - dd/mm/yyyy');
		equalCDate(ic.parseDate('dd/mm/yyyy', '03/02/1388'), d, 'Iranian parse - dd/mm/yyyy');
		equalCDate(ic.parseDate('dd/mm/yyyy', '03/02/-1'), ic.newDate(-1, 2, 3), 'Iranian parse - dd/mm/yyyy');
		equalCDate(ic.parseDate('d/m/yy', '3/2/88'), d, 'Iranian parse - d/m/yy');
		equalCDate(ic.parseDate('yyyy-mm-dd', '1388-02-03'), d, 'Iranian parse - yyyy-mm-dd');
		equalCDate(ic.parseDate('yy-o', '88-34'), d, 'Iranian parse - yy-o');
		equalCDate(ic.parseDate('yyyy-oo', '1388-034'), d, 'Iranian parse - yyyy-oo');
		equalCDate(ic.parseDate('D, M d, yyyy', 'Panj, Ord 3, 1388'), d,
			'Iranian parse - D, M d, yyyy');
		equalCDate(ic.parseDate('DD, MM d, yyyy', 'Panjshanbeh, Ordibehesht 3, 1388'), d,
			'Iranian parse - DD, MM d, yyyy');
		equalCDate(ic.parseDate('\'day\' d \'of\' MM \'in the year\' YYYY',
			'day 3 of Ordibehesht in the year 1388'), d,
			'Iranian parse - \'day\' d \'of\' MM \'in the year\' YYYY');
		equalCDate(ic.parseDate('@', '1240444800'), d, 'Iranian parse - @');
		equalCDate(ic.parseDate('!', '633760416000000000'), d, 'Iranian parse - !');
		equalCDate(ic.parseDate('J', '2454944.5'), d, 'Iranian parse - J');
		equalCDate(ic.parseDate('J', 2454944.5), d, 'Iranian parse - J numeric');
	});
	...
	test('Gregorian vs Iranian', function() {
		expect(18);
		var gc = $.calendars.instance('Gregorian');
		var ic = $.calendars.instance('Iranian');
		equal(gc.newDate(2009, 3, 1).toJD(), ic.newDate(1387, 12, 11).toJD(),
			'Gregorian vs Iranian - 01/03/2009 - 11/12/1387');
		equalDate(gc.newDate(2009, 3, 1).toJSDate(), ic.newDate(1387, 12, 11).toJSDate(),
			'Gregorian vs Iranian - 01/03/2009 - 11/12/1387');
		equal(gc.newDate(2009, 8, 5).toJD(), ic.newDate(1388, 5, 14).toJD(),
			'Gregorian vs Iranian - 05/08/2009 - 14/05/1388');
		equalDate(gc.newDate(2009, 8, 5).toJSDate(), ic.newDate(1388, 5, 14).toJSDate(),
			'Gregorian vs Iranian - 05/08/2009 - 14/05/1388');
		equal(gc.newDate(1993, 3, 21).toJD(), ic.newDate(1372, 1, 1).toJD(),
			'Gregorian vs Iranian - 21/03/1993 - 01/01/1372'); // http://en.wikipedia.org/wiki/Jalali_calendar
		equalDate(gc.newDate(1993, 3, 21).toJSDate(), ic.newDate(1372, 1, 1).toJSDate(),
			'Gregorian vs Iranian - 21/03/1993 - 01/01/1372'); // "
		equal(gc.newDate(1990, 6, 22).toJD(), ic.newDate(1369, 4, 1).toJD(),
			'Gregorian vs Iranian - 22/06/1990 - 01/04/1369'); // http://www.ortelius.de/kalender/pers_en.php
		equalDate(gc.newDate(1990, 6, 22).toJSDate(), ic.newDate(1369, 4, 1).toJSDate(),
			'Gregorian vs Iranian - 22/06/1990 - 01/04/1369'); // "
		equal(gc.newDate(2008, 3, 20).toJD(), ic.newDate(1387, 1, 1).toJD(),
			'Gregorian vs Iranian - 20/03/2008 - 01/01/1387'); // "
		equalDate(gc.newDate(2008, 3, 20).toJSDate(), ic.newDate(1387, 1, 1).toJSDate(),
			'Gregorian vs Iranian - 20/03/2008 - 01/01/1387'); // "
		equal(gc.newDate(1588, 2, 29).toJD(), ic.newDate(966, 12, 10).toJD(),
			'Gregorian vs Iranian - 29/02/1588 - 10/12/0966'); // http://www.alavi.us/jcal/
		equalDate(gc.newDate(1588, 2, 29).toJSDate(), ic.newDate(966, 12, 10).toJSDate(),
			'Gregorian vs Iranian - 29/02/1588 - 10/12/0966'); // http://www.alavi.us/jcal/
		equal(gc.newDate(2621, 6, 6).toJD(), ic.newDate(2000, 3, 16).toJD(),
			'Gregorian vs Iranian - 06/06/2621 - 16/03/2000'); // "
		equalDate(gc.newDate(2621, 6, 6).toJSDate(), ic.newDate(2000, 3, 16).toJSDate(),
			'Gregorian vs Iranian - 06/06/2621 - 16/03/2000'); // "
		equal(gc.newDate(622, 3, 22).toJD(), ic.newDate(1, 1, 1).toJD(),
			'Gregorian vs Iranian - 22/03/0622 - 01/01/0001');
		equalDate(gc.newDate(622, 3, 22).toJSDate(), ic.newDate(1, 1, 1).toJSDate(),
			'Gregorian vs Iranian - 22/03/0622 - 01/01/0001');
		equal(gc.newDate(2025, 3, 20).toJD(), ic.newDate(1403, 12, 30).toJD(),
			'Gregorian vs Iranian - 01/01/0001 - 11/10/-0622');
		equalDate(gc.newDate(2025, 3, 20).toJSDate(), ic.newDate(1403, 12, 30).toJSDate(),
			'Gregorian vs Iranian - 01/01/0001 - 11/10/-0622');
	});
